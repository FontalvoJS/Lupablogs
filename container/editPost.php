        ...
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <?php require_once '../component/botonPerfil.php' ?>
            ...
            <form id="alterForm" enctype="multipart/form-data">
                <div class="col-lg-12 col-md-12 col-xl-12 col-sm-12 mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $result['titulo']; ?>" name="titulo" id="" class="form-control" placeholder="">
                    </div>
                ...
                <div class="col-lg-12 col-md-12 col-xl-12 col-sm-12 mb-3">
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $result['descripcion']; ?>" name="descripcion" id="" class="form-control" placeholder="">
                    </div>
                </div>
                <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-xl-12 col-sm-12">
                    <div class="form-group mt-4">
                        ...
                        <textarea name="redaccion" id="summernote" class="form-textarea"><?php echo $result['redaccion'] ?></textarea>
                    </div>
                </div>
                <button type="button" onclick="alterPost(<?php echo $result['id']; ?>);" class="btn btn-primary" style="margin-top:5%;float:right">Save</button>
            </form>
        </div>
        <div class="row">
            <div class="col-12">
