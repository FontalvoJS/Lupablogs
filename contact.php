          ...
          <form id="contactForm" class="php-email-form">
            <div class="row">
              <div class="form-group col-md-6">
                <input type="text" name="name" class="form-control mb3" id="name" placeholder="Your Name" required>
              </div>
              <div class="form-group col-md-6">
            ...
            <div class="text-center"><button type="button" class="btn btn-primary" onclick="sendFormContact()">Send Message</button></div>
          </form>
