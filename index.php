<?php
session_start();
if (isset($_SESSION['username']) && isset($_COOKIE['active']) && $_COOKIE['active'] == $_SESSION['username']) {
...
<body>
  <?php
  require_once 'component/modalLogin.php';
  require_once 'component/modalRegistro.php';
  ?>
        ...
        <ul>
          ...
          <li class="dropdown"><a><span>Categories</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              ...
              <li>
                <a href="vistas/category.php?categoria=Healths">Healths</a>
              </li>
              <li>
                <a href="vistas/category.php?categoria=War">War</a>
              </li>
            </ul>
          </li>
